		...
		<form>
			...
			<v-dialog v-model="dialogConfirmacion" :width="600">
				<v-card color="#47d847">
					...
					<v-card-text>
						<v-alert :value="true" color="white" type="success" outlined>{{
							mensaje
						}}</v-alert>
					</v-card-text>
				...
				<v-card color="#47d847">
					<v-card-title>
						<span class="mx-auto" style="color: white"
							>¡Registro de Materiales Éxitoso!</span
						>
					</v-card-title>
					<v-card-text>
						<v-alert :value="true" color="white" type="success" outlined>{{
...
<style>
	.registrar-m .Materiales {
		margin: 20px;
		max-width: 100%;
	}
	.registrar-m .button-1 {
		background: #033076;
		color: #ffffff;
		border-color: #232323;
		border-width: 5px;
	...
	.registrar-m .contenedor-cajas-1 {
		border: 2px solid #abf5b7;
		padding: 10px;
		background-color: #fefffe;
	}
	.registrar-m .contenedor-cajas input {
		margin-bottom: 5px;
		width: 100%;
		padding: 5px;
		margin-top: 20px;
	...
	.registrar-m .custom-table thead th {
