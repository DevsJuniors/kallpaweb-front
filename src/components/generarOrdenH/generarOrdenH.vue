...
<style>
	...
	.generar-orden-h .contenedor-cajas-1 {
		border: 2px solid #abf5b7;
		padding: 10px;
		background-color: #ffffff;
		margin-left: 15px;
	...
	.generar-orden-h .contenedor-cajas input {
		margin-bottom: 5px;
		width: 100%;
		padding: 5px;
	}
	.generar-orden-h .button-1 {
		background: #033076;
		color: #ffffff;
		border-color: #232323;
		border-width: 5px;
	...
	.generar-orden-h .kallpa-image {
		margin-top: 35px;
	}
	.generar-orden-h .fill-height {
		height: 100%;
	}

	.generar-orden-h .tabla {
		width: 100%;
	}

	.generar-orden-h .custom-table thead th {
		background-color: #095ba8;
		color: #ffffff !important;
	}
</style>
<script src="./generarOrdenH.js"></script>
