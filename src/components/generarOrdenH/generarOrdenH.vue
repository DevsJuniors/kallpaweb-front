    ...
    <div>
      <v-app-bar color="white" dense dark height="80">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <h2 style="color: rgba(0, 0, 129, 0.829); margin-right: 10px;font-size: 30px;font-weight: bold">Generar Orden</h2>
            <h2 style="color: rgb(62, 207, 62);font-size: 30px;font-weight: bold">de Habilitación</h2>
        </div>
                ...
                <div style="display: flex; align-items: center;">
                  ...
                  <div class="contenedor-cajas my-4" style="margin-left: 10px;">
                    ...
                    <div style="display: flex; align-items: center;">
                      ...
                      filled 
                      :disabled="!TextFieldAble" 
                      v-model="frmOrdenH.IDEtapa"></v-text-field>
                      <v-text-field 
                      label="ID Contrato" 
                      placeholder=""
                      style="width: 18%; margin-right: 5px;" 
          ...
          <div class="tabla fill-height">
           <v-data-table
                ...
                <template v-slot:item="{item}">
                    ...
                    <td>{{ item.DNI_Em }}</td>
                    <td>{{ item.Visualizar}}
                            <v-btn small color="primary" @click="seleccionarOrden(item)">
            ...
            <v-btn type="submit" class="button-1 mt-3" depressed color="primary" style="width: 30%;">
           Generar Orden
        ...
        <v-dialog v-model="dialogError" :width="500">
                ...
                <v-dialog v-model="dialogVisualizar" :width="800">
                    <v-card color="#ffffff" class="pa-0">
                      <v-card-title>
                        <div style="display: flex; align-items: center;">
                          <span class="mx-auto" style="color: #033076;margin-right: 2px"> Kallpa Contratistas y</span>
                          <span class="mx-auto" style="color: #41d81c;margin: 2px">Suministros </span>
                        </div>
                          <span class="mx-auto" style="color: #000000;margin: 2px;font-size: 14px;white-space: pre-line">{{menCabecera}} </span>
                      </v-card-title>
                      <v-card-text class="mt-n">
                        ...
                        <v-card-actions class="mb-n" style="display: flex; justify-content: center">
                        <v-btn style="background-color: #033076; color: #ffffff;" @click="cerrar">
                          Aceptar
                        </v-btn>
                      </v-card-actions>
