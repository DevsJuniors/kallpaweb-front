<template>
    <div>
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <h2 style="color: rgba(0, 0, 129, 0.829); margin-right: 10px;font-size: 30px;font-weight: bold">Visualización de</h2>
            <h2 style="color: rgb(62, 207, 62);font-size: 30px;font-weight: bold">Consolidado de Contratos</h2>
        </div>
        <v-container fluid>
         <div class="d-flex flex-grow-1">
          <div class="tabla" style="margin-right: 15px;">
           <v-data-table
            ...
            <v-btn
                depressed
                style="background-color: #47d847; color: #ffffff;margin-left: 10px;width: 30%"
            ...
            <v-btn
                depressed
                style="background-color: #47d847; color: #ffffff;margin-left: 15px;width: 30%"
                class="mt-2 mb-4 x-large"
