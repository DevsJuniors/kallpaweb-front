<template>
    <div>
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            ...
            <h2 style="color: rgb(62, 207, 62);font-size: 30px;font-weight: bold">de Instalación</h2>
        </div>
            ...
            <div style="width: 100%;">
              <v-container fluid>
                <div style="display: flex; align-items: center;">
                  <v-icon style="color: rgb(62, 207, 62); font-size: 100px;">mdi-book-cog</v-icon>
