...
export default {
	...
	methods: {
		loadVuetifyStyles() {
			// Simular una espera de 2 segundos antes de cargar los estilos de Vuetify
			setTimeout(() => {
				import("vuetify/dist/vuetify.min.css")
					...
					.catch((error) => {
						console.error("Error al cargar los estilos de Vuetify", error);
						this.loading = false;
					});
			}, 2000); // Tiempo de espera en milisegundos (en este caso, 2 segundos)
		},
		obtenerEmpleados() {
			this.axios
