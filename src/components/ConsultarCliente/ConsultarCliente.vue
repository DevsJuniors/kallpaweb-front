				...
				<div class="cliente">
					...
					<div class="contenedor-cajas">
						...
						<v-select
							...
							:items="
								estadosciviles.map((estadocivil) => estadocivil.Descripcion_Es)
							"
...
<style>
	.consultar-cliente .kallpa-image {
		margin-top: 35px;
	}
	.consultar-cliente .cliente {
		margin: 20px;
		max-width: 70%;
	}
	.consultar-cliente .contenedor-cajas-E {
		border: 2px solid #ffffff;
		padding: 10px;
	}
	.consultar-cliente .custom-table thead th {
		background-color: #095ba8;
		color: #ffffff !important;
	}
	.consultar-cliente .contenedor-cajas {
		border: 2px solid #47d847;
		padding: 10px;
	}

	.consultar-cliente .contenedor-cajas input {
		margin-bottom: 5px;
		width: 100%;
		padding: 5px;
	}
	.consultar-cliente .fill-height {
		height: 100%;
	}
	.consultar-cliente .tabla {
		width: 100%;
	}
	.consultar-cliente .custom-text {
		font-size: 12px; /* Modifica el tamaño de letra según tus necesidades */
	}
	.consultar-cliente .button-1 {
		background: #033076;
		color: #ffffff;
		border-color: #232323;
		border-width: 5px;
